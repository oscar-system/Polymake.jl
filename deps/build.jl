...
bin_prefix = "https://github.com/benlorenz/polymakeBuilder/releases/download/v3.4-2"

# Listing of files generated by BinaryBuilder:
download_info = Dict(
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/polymake.v3.4.0.i686-linux-gnu-gcc6.tar.gz", "4f8d33b964fd9ce2b8ac146f0f3cd7d8afd0a43142ca761c09b8ee7b393cffaa"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v3.4.0.i686-linux-gnu-gcc7.tar.gz", "727242fa5ef47d3113f1f4254471313da056d3662d46f7e3a89caf3cb71099a9"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v3.4.0.i686-linux-gnu-gcc8.tar.gz", "9689183b2408cc672f6f515938eb55f4be9469082190ebaeb3385de0da434299"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/polymake.v3.4.0.x86_64-linux-gnu-gcc6.tar.gz", "7f6684acdf22230b0d33ce1fb566de7342d11b2e5e98fc15e3d93c0221a8a260"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v3.4.0.x86_64-linux-gnu-gcc7.tar.gz", "6670a2c299bb7a6a8747a40bc01e1137f34c89543f5d933943d5755978846f5a"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v3.4.0.x86_64-linux-gnu-gcc8.tar.gz", "657ff3396435588d3c62dd07fd7e1d871edf80f702168b9192a20920772169a7"),
)
