...
bin_prefix = "https://github.com/benlorenz/polymakeBuilder/releases/download/v3.6-1"

# Listing of files generated by BinaryBuilder:
download_info = Dict(
    MacOS(:x86_64) => ("$bin_prefix/polymake.v3.6.0.x86_64-apple-darwin14.tar.gz", "004df79e5bc5dd0397463616a2d75d050958061da53290f466de88f475c9e4ef"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/polymake.v3.6.0.x86_64-linux-gnu-gcc6.tar.gz", "7791a19c7a9e3eccf9e8c220a3e7e47bb993ebb96638fe0f8ead5c2777a0a262"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v3.6.0.x86_64-linux-gnu-gcc7.tar.gz", "d4bd3665edd322ecaec647e7d178cfe6a1ba9390d3a97665348f872eb5f6e92f"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v3.6.0.x86_64-linux-gnu-gcc8.tar.gz", "36c8e5da95feaf7b365cb89a4b87e1c5c22a1231cace2b76834fb8a8f8944701"),
)
