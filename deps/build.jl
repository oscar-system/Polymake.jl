...
bin_prefix = "https://github.com/benlorenz/polymakeBuilder/releases/download/v3.5-1"

# Listing of files generated by BinaryBuilder:
download_info = Dict(
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/polymake.v3.5.0.i686-linux-gnu-gcc6.tar.gz", "826033275505bfba6b861b54100854775ca537ad0dbec52f2076f537b03fd1e4"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v3.5.0.i686-linux-gnu-gcc7.tar.gz", "80a930cc47789f9e46eac880ba4d91798178d8d8321b9b42cff4210eb51b664d"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v3.5.0.i686-linux-gnu-gcc8.tar.gz", "c0813e9054b187d99f1c467dd72ebdd9fe8df35a6d0911aa70e80fde6d02d2ba"),
    MacOS(:x86_64) => ("$bin_prefix/polymake.v3.5.0.x86_64-apple-darwin14.tar.gz", "475b73afe5915d94922cc87ab0f13d63837ecad68e80a918cc23b47da8bb0623"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/polymake.v3.5.0.x86_64-linux-gnu-gcc6.tar.gz", "8f3458cb8af46a64a04165d7a20a639032a8d8c23576410c33439fb8ab9f3d11"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v3.5.0.x86_64-linux-gnu-gcc7.tar.gz", "2b43007e3d54a72be3015562d4e1d4d418cfdf8a9f7dab90fc25904458231557"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v3.5.0.x86_64-linux-gnu-gcc8.tar.gz", "90a7385fdf98aa488f49cc302d0e5d211f503e02b08c53a30e22c5e66f32eec2"),
)
