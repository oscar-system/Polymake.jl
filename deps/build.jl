...
bin_prefix = "https://github.com/benlorenz/polymakeBuilder/releases/download/v3.6"

# Listing of files generated by BinaryBuilder:
download_info = Dict(
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/polymake.v3.6.0.i686-linux-gnu-gcc6.tar.gz", "c3a8cc5508cd259e343854ab007ce444b6acaee6d086c602e968afd1369ad483"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v3.6.0.i686-linux-gnu-gcc7.tar.gz", "48ecfdb0988edad0863822c7af76a4a69345253d7a6a8cda2cfc452445eba48c"),
    Linux(:i686, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v3.6.0.i686-linux-gnu-gcc8.tar.gz", "74986699f8557f0dcfd2bb01f0ec5a6e1018955b9b4d206ac10e94a51a6b75bb"),
    MacOS(:x86_64) => ("$bin_prefix/polymake.v3.6.0.x86_64-apple-darwin14.tar.gz", "43e33fbcc2fa754de050072c003f6cd3e5d9e9521abd9aa8517bc29c393baabb"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/polymake.v3.6.0.x86_64-linux-gnu-gcc6.tar.gz", "1fc05386c2d4e0e916c27e7872e62fb7ea89939775a48d3a5d5121b6fc19a2db"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v3.6.0.x86_64-linux-gnu-gcc7.tar.gz", "682a9064b5426264018e1289a5d48d04a872ad26a504c69b27e807e00f94eb14"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v3.6.0.x86_64-linux-gnu-gcc8.tar.gz", "c279205c10704cb1cbde7c0bcbb94fee23a2e7497b9a09dda372f323f7de9c87"),
)
