...
bin_prefix = "https://github.com/benlorenz/polymakeBuilder/releases/download/v4.0-rc1"

# Listing of files generated by BinaryBuilder:
download_info = Dict(
    MacOS(:x86_64) => ("$bin_prefix/polymake.v4.0.0.x86_64-apple-darwin14.tar.gz", "5967863e0728c0705075d058dad32bcd41e7f52c095fa8950187d0e60516f851"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc6)) => ("$bin_prefix/polymake.v4.0.0.x86_64-linux-gnu-gcc6.tar.gz", "74471a07e680a13c90e4dea970811969c2789146a7018ef08ef55a05b0b9485a"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v4.0.0.x86_64-linux-gnu-gcc7.tar.gz", "e141cc4b4feaaf4c560097e8c0db44e53114c427f584382f0d5f1ae5e5f53eb4"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v4.0.0.x86_64-linux-gnu-gcc8.tar.gz", "6ec225362ae9df243c6065b0f8997d45bf530512d1f5b5b8e21b96b299cc7bac"),
)
