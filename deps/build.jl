...
bin_prefix = "https://github.com/benlorenz/polymakeBuilder/releases/download/v3.2.0-dev-46e2f53417-r1"

# Listing of files generated by BinaryBuilder:
download_info = Dict(
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc8)) => ("$bin_prefix/polymake.v3.2.0-dev-46e2f53417-r1.x86_64-linux-gnu-gcc8.tar.gz", "6fd2f488eb53d5b8356c5bd4948efdd5584f291e774cae2678f9e9426698062b"),
    Linux(:x86_64, libc=:glibc, compiler_abi=CompilerABI(:gcc7)) => ("$bin_prefix/polymake.v3.2.0-dev-46e2f53417-r1.x86_64-linux-gnu-gcc7.tar.gz", "e16e86d726b45325fcd474e3fdb7281c23c4d94ca82fe9628c50cc99522343c8"),
)
