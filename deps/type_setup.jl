...
( "Polynomial_int_int",          "pm::Polynomial<int,int>",                  "Polynomial{Int32,Int32}",      "to_polynomial_int_int"),
...
( "Polynomial_Integer_int",      "pm::Polynomial<pm::Integer,int>",          "Polynomial{Integer,Int32}",    "to_polynomial_Integer_int"),
...
( "Polynomial_Rational_int",     "pm::Polynomial<pm::Rational,int>",         "Polynomial{Rational,Int32}",   "to_polynomial_Rational_int"),
...
( "Polynomial_double_int",       "pm::Polynomial<double,int>",               "Polynomial{Float64,Int32}",    "to_polynomial_double_int"),
