...
( "Array_Pair_Int_Int",          	"pm::Array<std::pair<pm::Int, pm::Int>>",   "Array{Pair{CxxWrap.CxxLong,CxxWrap.CxxLong}}", "to_array_pair_int_int" ),
#( "Array_List_Pair_Integer_Integer",    "pm::Array<std::list<std::pair<pm::Int, pm::Int>>>",       "Array{Array{Pair{CxxWrap.CxxLong,CxxWrap.CxxLong}}}",       "to_array_list_pair_int_int" ),
