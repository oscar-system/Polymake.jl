...
( "Pair_Int",                    	"std::pair<pm::Int, pm::Int>",              "StdPair{CxxWrap.CxxLong,CxxWrap.CxxLong}",      "to_pair_int" ),
( "List_Pair_Int",                    	"std::list<std::pair<pm::Int, pm::Int>>",   "StdList{StdPair{CxxWrap.CxxLong,CxxWrap.CxxLong}}", "to_list_pair_int" ),
...
( "Array_Pair_Int_Int",          	"pm::Array<std::pair<pm::Int, pm::Int>>",   "Array{StdPair{CxxWrap.CxxLong,CxxWrap.CxxLong}}", "to_array_pair_int_int" ),
( "Array_List_Pair_Integer_Integer",    "pm::Array<std::list<std::pair<pm::Int, pm::Int>>>",       "Array{StdList{StdPair{CxxWrap.CxxLong,CxxWrap.CxxLong}}}",       "to_array_list_pair_int_int" ),
