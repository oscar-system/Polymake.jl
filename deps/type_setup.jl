...
( "Polynomial_Int_Int",          "pm::Polynomial<long,long>",                "Polynomial{Int64,Int64}",      "to_polynomial_int_int"),
# ( "Polynomial_Int_Integer",      "pm::Polynomial<int,pm::Integer>",          "Polynomial{Int32,Integer}",    "to_polynomial_int_Integer"),
# ( "Polynomial_Int_Rational",     "pm::Polynomial<int,pm::Rational>",         "Polynomial{Int32,Rational}",   "to_polynomial_int_Rational"),
# ( "Polynomial_Int_double",       "pm::Polynomial<int,double>",               "Polynomial{Int32,Float64}",    "to_polynomial_int_double"),
( "Polynomial_Integer_Int",      "pm::Polynomial<pm::Integer,long>",         "Polynomial{Integer,Int64}",    "to_polynomial_integer_int"),
# ( "Polynomial_Integer_Integer",  "pm::Polynomial<pm::Integer,pm::Integer>",  "Polynomial{Integer,Integer}",  "to_polynomial_Integer_Integer"),
# ( "Polynomial_Integer_Rational", "pm::Polynomial<pm::Integer,pm::Rational>", "Polynomial{Integer,Rational}", "to_polynomial_Integer_Rational"),
# ( "Polynomial_Integer_double",   "pm::Polynomial<pm::Integer,double>",       "Polynomial{Integer,Float64}",  "to_polynomial_Integer_double"),
( "Polynomial_Rational_Int",     "pm::Polynomial<pm::Rational,long>",        "Polynomial{Rational,Int64}",   "to_polynomial_rational_int"),
# ( "Polynomial_Rational_Integer", "pm::Polynomial<pm::Rational,pm::Integer>", "Polynomial{Rational,Integer}", "to_polynomial_Rational_Integer"),
# ( "Polynomial_Rational_Rational","pm::Polynomial<pm::Rational,pm::Rational>","Polynomial{Rational,Rational}","to_polynomial_Rational_Rational"),
# ( "Polynomial_Rational_double",  "pm::Polynomial<pm::Rational,double>",      "Polynomial{Rational,Float64}", "to_polynomial_Rational_double"),
( "Polynomial_double_Int",       "pm::Polynomial<double,long>",              "Polynomial{Float64,Int64}",    "to_polynomial_double_int"),
# ( "Polynomial_double_Integer",   "pm::Polynomial<double,pm::Integer>",       "Polynomial{Float64,Integer}",  "to_polynomial_double_Integer"),
# ( "Polynomial_double_Rational",  "pm::Polynomial<double,pm::Rational>",      "Polynomial{Float64,Rational}", "to_polynomial_double_Rational"),
# ( "Polynomial_double_double",    "pm::Polynomial<double,double>",            "Polynomial{Float64,Float64}",  "to_polynomial_double_double"),
]
    NT.(type_tuples)
end
