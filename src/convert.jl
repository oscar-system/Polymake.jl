...
for (pm_T, jl_T) in [
        ...
        (pm_Set, AbstractSet),
        (pm_SparseVector, AbstractVector)
        ]
    @eval begin
...
convert_to_pm_type(::Type{<:Union{AbstractSparseVector, pm_SparseVector}}) = pm_SparseVector
...
function promote_to_pm_type(::Type{<:Union{pm_Vector, pm_Matrix, pm_SparseVector}}, S::Type{<:Integer})
