...
function Base.setindex!(M::EdgeMap{TK, TV}, i::Int, j::Int, val::TV) where {TK, TV}
  index = to_zero_based_indexing.([i, j])
...
function Base.setindex!(M::EdgeMap{TK, TV}, index::NTuple{2, Int}, val::TV) where {TK, TV}
...
function Base.setindex!(M::NodeMap{TK, TV}, i::Int, val::TV) where {TK, TV}
