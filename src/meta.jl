...
import Polymake: Rational, PolymakeType, PropertyValue, OptionSet, QuadraticExtension, JuliaFieldElement
...
translate_type_to_pm_string(::Type{<:JuliaFieldElement}) = "JuliaFieldElement"
