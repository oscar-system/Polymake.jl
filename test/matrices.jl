@testset "Polymake.Matrix" begin
    ...
    @testset "Constructors/Converts" begin
        ...
        for T in [IntTypes; Polymake.Integer]
            @test Polymake.Matrix(T.(jl_m)) isa Polymake.Matrix{T == Int64 ? Int64 : Polymake.Integer}
    ...
    @testset "Low-level operations" begin
        @testset "Polymake.Matrix{Int64}" begin
            ...
            for T in [IntTypes; Polymake.Integer]
                ...
                M[2, 1] = T(10)
                @test M[2, 1] == 10
                @test string(M) == "pm::Polymake.Matrix<int>\n5 2 3\n10 5 6\n"
            end
        end
        ...
        @testset "Polymake.Matrix{Polymake.Integer}" begin
            ...
            for T in [IntTypes; Polymake.Integer]
                ...
                V[2, 1] = T(10)
                @test V[2, 1] == 10
                @test string(V) == "pm::Polymake.Matrix<pm::Polymake.Integer>\n5 2 3\n10 5 6\n"
            end
        end
        ...
        @testset "Polymake.Matrix{Polymake.Rational}" begin
            ...
            for T in [IntTypes; Polymake.Integer]
                ...
                V[2] = T(10)//T(3)
                @test V[2] == 10//3
                @test string(V) == "pm::Polymake.Matrix<pm::Polymake.Rational>\n5/3 2 3\n10/3 5 6\n"
            end
        end
        ...
        @testset "Polymake.Matrix{Float64}" begin
            ...
            for T in [IntTypes; Polymake.Integer]
                ...
                @test string(V) == "pm::Polymake.Matrix<double>\n1.66667 2 3\n3.33333 5 6\n"
            end
        end
    ...
    @testset "Arithmetic" begin
        ...
        @test 2X isa Polymake.Matrix{Polymake.Integer}
        @test Int64(2)X isa Polymake.Matrix{Int64}
